"""Backflip tracking task configuration.

This module defines the base configuration for backflip tracking tasks.
...
def create_backflip_env_cfg(
  ...
  """Create a backflip locomotion task configuration.
  ...
  Args:
    ...
    body_ang_vel_weight: Weight for body angular backflip penalty.
